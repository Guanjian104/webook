...
import (
    ...
    cachemocks "github.com/Guanjian104/webook/internal/repository/cache/mocks"
    "github.com/Guanjian104/webook/internal/repository/dao"
    daomocks "github.com/Guanjian104/webook/internal/repository/dao/mocks"
    ...
    }{
        {
            ...
            mock: func(ctrl *gomock.Controller) (cache.UserCache, dao.UserDAO) {
                ...
                c.EXPECT().Set(gomock.Any(), domain.User{
                    ...
                    Email:       "123@qq.com",
                    Password:    "123456",
                    Birthday:    time.UnixMilli(100).String(),
                    Description: "自我介绍",
                    Phone:       "15212345678",
                    Ctime:       now,
                }).Return(nil)
